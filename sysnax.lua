...
-- WindUI · All features · No API errors
...
-- Avatar & basic info (manually built to avoid API bugs)
if HomeTab.Frame then
    ...
    -- Name, display name, executor directly on the tab
    ...
    displayLabel.Position = UDim2.new(0, 100, 0, 40)
    ...
    execLabel.Position = UDim2.new(0, 100, 0, 60)
...
serverSection:AddLabel("Region: " .. (game:GetService("LocalizationService").RobloxLocaleId or "N/A"))
...
-- Scrollable script list (manually built on the tab frame)
local listFrame = nil
if ScriptHub.Frame then
    listFrame = Instance.new("ScrollingFrame")
    listFrame.Size = UDim2.new(1, -20, 0, 270)
