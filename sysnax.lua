-- Sysnax ScriptHub (Final, no GetSectionFrame)
-- WindUI · All features · Works on any executor
...
-- Avatar & basic info (directly on the tab's frame)
...
-- Server info section (using WindUI section for the labels)
...
-- Search & filters (WindUI sections)
...
-- Scrollable script list (directly on the ScriptHub's frame)
local listFrame = nil
